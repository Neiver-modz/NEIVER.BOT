...
const smsSaludo = () => { return `👋 !HOLA! BIENVENIDO(A)AL BOT NEIVER.BOT👋`}
...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE NEIVER.BOT 🌟`}
const smsLista2 = () => { return `💖 CREADORE 💖`}
const smsLista3 = () => { return `🎁 DONAR 🎁`}
const smsLista4 = () => { return `🚀 VELOCIDAD DEL BOT 🚀`}
const smsLista5 = () => { return `💡 INFORMACIÓN DEL MENÚ 💡`}
const smsLista6 = () => { return `🤤MENÚ COMPLETO 🤤`}
const smsLista7 = () => { return `👾 INSTALAR NEIVER.BOT 👾`}
...
//main.js
const smsWelcome = () => { return `*╭┈⊰* @subject *⊰┈ ✦*\n*┊✨HOLA TE SALUDA NEIVER.BOT TE DA LA BIENVENIDO(A)!!*\n┊💖 @user\n┊📄 *LEA LA DESCRIPCIÓN DEL GRUPO PARA NO SER ELIMINADO*\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ ✦*\n${String.fromCharCode(8206).repeat(850)}\n@desc`}
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *EL IDIOTA SE SALIO ES FAN DE BTS!!* 😎\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
...
const smsCargando = () => { return `✨ CARGANDO CÓDIGO..\n`} 
...
//_allantilink.js
const smsTextoYT = () => { return '🤖NEIVER.BOT_OFC🤖 '} 
...
//_antilink.js
const smsAdwa = () => { return `${global.lenguajeGB['smsAvisoEG']()}𝘾𝙊𝙈𝙊 𝙀𝙍𝙀𝙎 𝘼𝘿𝙈𝙄𝙉 𝙀𝙉 𝙀𝙇 𝙂𝙍𝙐𝙋𝙊 𝙉𝙊 𝙎𝙀𝙍𝘼𝙎 𝙀𝙇𝙄𝙈𝙄𝙉𝘼𝘿𝙊(𝘼) TÚVISTES 🍀`}
...
const smsToxic5 = () => { return `👾 𝘿𝙀𝙎𝘼𝘾𝙏𝙄𝙑𝘼𝙍 𝘼𝙉𝙏𝙄𝙏𝙊𝙓𝙄𝘾`} //🟡 NO CAMBIAR 
...
const eGataCoins = () => { return '🐱 neiverCoins' }
const eGataTickers = () => { return '🎫 neiver Tickers' } 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar neiverbot`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar neiverbot en Grupos`}
...
//_autolevelup.js
const smsAutoLv1 = () => { return `🎖️ nivel nuevo 🎖️`} 
...
const smsAutoLv6 = () => { return `Has alcanzado un Nuevo Nivel en el bot!!!`} 
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n𝙀𝙎 𝙐𝙉 𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 🪄 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 🎈 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎, 𝘿𝙄𝙎𝙁𝙍𝙐𝙏𝘼 𝘿𝙀 NEIVER.BOT!! 😸
🤖\n\n💖 NEIVERBOT 𝙁𝙐𝙀 𝙄𝙉𝙑𝙄𝙏𝘼𝘿𝘼 𝙋𝙊𝙍:\n@${user}`}
...
const smsContacto2 = () => { return 'Soy Owner de neiver_modz ' + packname + ' sí tienes alguna duda me la puedes decir ✌️'}
const smsContacto3 = () => { return '👑 Owner'}
const smsContacto4 = () => { return 'Contacto Oficial de neiverbot😈'}
