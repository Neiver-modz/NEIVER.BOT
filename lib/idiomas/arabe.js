...
const smsLista1 = () => { return `🌟 معلومات NEIVERBOT🌟`}
...
const smsLista7 = () => { return `🐈 تثبيت NEIVERBOT 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 ممتاز NEIVERBOT- WhatsApp '}
...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام NEIVERBOT`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام NEIVERBOT في المجموعات`}
